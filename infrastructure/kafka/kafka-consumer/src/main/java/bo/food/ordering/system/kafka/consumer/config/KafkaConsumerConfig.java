package bo.food.ordering.system.kafka.consumer.config;

import bo.food.ordering.system.kafka.config.data.KafkaConfigData;
import bo.food.ordering.system.kafka.config.data.KafkaConsumerConfigData;
