package bo.food.ordering.system.order.service.domain.mapper;
...
public class OrderDataMapper {
    ...
    private List<OrderItem> orderItemsToOrderItemEntities(List<bo.food.ordering.system.order.service.domain.dto.create.OrderItem> orderItems) {
